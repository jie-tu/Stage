...
path_to_bati = "G:/523/bati_clip.shp"
bati = layer (path_to_bati,"bati")


path_to_batiment_clip = "G:/523/voronoi/cleaned/batiment_cleaned.shp"
batiment_clip = layer (path_to_batiment_clip,"batiment_layer")

path_to_batiment_single_polygon = "G:/523/voronoi/batiment_single_polygon.shp"
...
######
path_to_batiment_boundary = "G:/523/voronoi/batiment_boundary.shp"
...
path_to_batiment_densified = "G:/523/voronoi/batiment_densified.shp"
processing.run("native:densifygeometriesgivenaninterval", {'INPUT':batiment_boundary,'INTERVAL':1.0, 'OUTPUT':path_to_batiment_densified})
batiment_densified = layer (path_to_batiment_densified,"batiment_densified")
print("batiment_densified")

path_to_batiment_converted = "G:/523/voronoi/batiment_converted.shp"
...
path_to_intersection = "G:/523/voronoi/path_to_intersection.shp"
processing.run("qgis:intersection", {'INPUT':batiment_converted,'OVERLAY' : path_to_bati, 'INPUT_FIELDS':'ID_2','OVERLAY_FIELDS':'ID' ,'OUTPUT' : path_to_intersection})
intersection = layer (path_to_intersection, 'intersection')
print ('intersection')

path_to_batiment_single_parts = "G:/523/voronoi/batiment_single_parts.shp"
processing.run("native:multiparttosingleparts", {'INPUT':intersection, 'OUTPUT': path_to_batiment_single_parts})
batiment_single_parts = layer (path_to_batiment_single_parts,"batiment_single_parts")
print ("batiment_single_parts")

path_to_voronoi =  "G:/523/voronoi/voronoi.shp"
...
path_to_voronoi_to_line =  "G:/523/voronoi/voronoi_to_line.shp"
...
path_to_line_explode = "G:/523/voronoi/line_explode.shp"
...
##############################################################
path_to_extracted = "G:/523/extracted.shp"
